...
export default buildModule('BankUpgradeModule', (m) => {
  ...
  const beacon = m.contractAt('Beacon', '<network_beacon_address>', { id: '<unique_beacon_id>' }) //e.g. 'Beacon_v1'
