<template>
  <div class="space-y-6">
    <UPageCard
      ...
      description="Track activity for any EOA or Safe wallet. Results are server-fetched and paginated for a clean table view."
      variant="naked"
...
function transactionUrl(hash: string | undefined): string | null {
  ...
  // Polymarket activity is on Polygon; always link to PolygonScan.
