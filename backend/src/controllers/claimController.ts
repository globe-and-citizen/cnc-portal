...
export const addClaim = async (req: AuthenticatedRequest, res: Response) => {
  ...
  if (hoursWorked <= 0)
    parametersError.push('Invalid hoursWorked, hoursWorked must be greater than 0')
