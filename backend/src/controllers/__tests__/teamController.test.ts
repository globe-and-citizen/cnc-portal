...
describe('Team Controller', () => {
  ...
  describe('getAllTeams', () => {
    ...
    it('should return 200 and a lsit of teams the user is a member of', async () => {
      ...
      const response = await request(app).get('/team').set('address', '0xABC123')
  ...
  describe('deleteTeam', () => {
    ...
    it('should return 404 if team not found', async () => {
      ...
      const response = await request(app).delete('/team').set('address', '0xOwnerAddress')
    ...
    it('should return 403 if user is not the team owner', async () => {
      ...
      const response = await request(app).delete('/team').set('address', '0xAnotherAddress')
