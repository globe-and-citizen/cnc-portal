    ...
    <div class="overflow-x-auto">
      <table class="min-w-full table-auto border border-gray-200">
        ...
        <tbody class="divide-y divide-gray-200">
          <tr>
            <td class="px-4 py-2 text-sm font-medium text-gray-900">Recipient</td>
            <td class="px-4 py-2 text-xs text-gray-700 font-mono">{{ recipientAddress || 'None' }}</td>
          </tr>
          <tr>
            <td class="px-4 py-2 text-sm font-medium text-gray-900">Amount (ETH)</td>
            <td class="px-4 py-2 text-sm text-gray-700">{{ ethAmount || '0' }}</td>
          </tr>
          <tr>
