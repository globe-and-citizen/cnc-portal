        ...
        <tbody class="divide-y divide-gray-200">
          <tr>
            ...
            <td class="px-4 py-2 text-sm">
              <span v-if="!isBankAddressValid" class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">
                Invalid
              </span>
          ...
          <tr>
            ...
            <td class="px-4 py-2 text-sm">
              <span v-if="pausedLoading" class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                Loading
              </span>
              <span v-else-if="pausedError" class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">
                Error
              </span>
              <span v-else class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">
                Loaded
          ...
          <tr>
            ...
            <td class="px-4 py-2 text-sm">
              <span v-if="ownerLoading" class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                Loading
              </span>
              <span v-else-if="ownerError" class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">
                Error
              </span>
              <span v-else class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">
                Loaded
          ...
          <tr>
            ...
            <td class="px-4 py-2 text-sm text-gray-700">
              ...
              <span v-else-if="tipsAddressError" class="text-red-600">{{ tipsAddressError.message }}</span>
              <span v-else class="font-mono text-xs">{{ tipsAddressData || 'N/A' }}</span>
            </td>
            <td class="px-4 py-2 text-sm">
              <span v-if="tipsAddressLoading" class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                Loading
              </span>
              <span v-else-if="tipsAddressError" class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">
                Error
              </span>
              <span v-else class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">
                Loaded
...
const { data: tipsAddressData, isLoading: tipsAddressLoading, error: tipsAddressError } = useBankTipsAddress()
</script>
