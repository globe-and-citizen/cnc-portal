<template>
  <GenericTransactionHistory :transactions="transactionData" title="Expense Account Transfer History"
    :currencies="currencies" :show-receipt-modal="true" data-test="expense-transactions"
