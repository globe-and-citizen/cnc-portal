<template>
  ...
  <h3 class="pt-8">
    This will transfer {{ amount }} {{ NETWORK.currencySymbol }} from the team {{ service.toLowerCase() }} contract to this
    address {{ to }}.
  </h3>
  <h3 class="pt-4">
    Current team {{ service.toLowerCase() }} contract's balance {{ bankBalance }} {{ NETWORK.currencySymbol }}
  </h3>
