<template>
    <div class="min-h-screen flex flex-col items-center">
      ...
      <div class="pt-10" v-if="!isRoleCategoriesFetching && roleCategories">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20" v-if="roleCategories.length != 0">
          <RoleCategoryCard
            data-test="teamcard"
        ...
        <div class="flex flex-col items-center" v-else="">
          ...
          <span class="font-bold text-sm text-gray-500 my-4"
            >There are currently no roles your team, {{ useUserDataStore().name }}. Create a new
            role now!</span
          >
