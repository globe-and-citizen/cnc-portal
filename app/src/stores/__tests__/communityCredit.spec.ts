...
const FUNDED_OFFER: FixedReturnRawOffer = {
  offerId: 3,
  decimals: 6,
  // startDate/maturityDate overridden together so maturity lands after the mocked NOW —
  // the default offer()'s maturityDate matured long before NOW, which would otherwise
  // resolve this to 'overdue' instead of the plain 'funded' this test is about.
  offer: offer({
    totalFunded: 40_000_000000n,
    state: 1,
    startDate: 1_999_000_000n,
