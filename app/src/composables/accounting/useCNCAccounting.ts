...
export function useCNCAccounting(
  ...
  const baseInput = computed<CncAccountingInput>(() => ({
    ...
    bankEvents: bank.data.value?.data,
    cashRemunerationEvents: cashRem.data.value?.data,
    expenseEvents: expense.data.value?.data,
    fixedReturnEvents: fixedReturn.data.value?.data,
    fixedReturnOfferTerms: fixedReturnOfferTerms.value,
    investorEvents: investor.data.value?.data,
    vestingEvents: vesting.data.value?.data,
    safeDepositRouterEvents: router.data.value?.data,
