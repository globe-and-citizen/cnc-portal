  ...
  describe('MetaMaskUtil', () => {
    ...
    describe('switchNetwork', () => {
      ...
      it('should add network when switch fails with code 4902', async () => {
        ...
        mockEthereum.request.mockRejectedValueOnce(switchError).mockResolvedValueOnce(undefined)
      ...
      it('should handle error when adding network fails', async () => {
        ...
        mockEthereum.request.mockRejectedValueOnce(switchError).mockRejectedValueOnce(addError)
