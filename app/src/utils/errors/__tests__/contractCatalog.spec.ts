...
import { CONTRACT_ERRORS, resolveRevertMessage } from '../contractCatalog'
import type { ContractKey } from '../contractCatalog.types'
...
describe('resolveRevertMessage', () => {
  ...
  describe('common resolvers with arguments', () => {
    ...
    // IERC20Errors coverage lives in contractCatalog.ierc20.spec.ts — this
    // file is already at the repo's max-lines limit.
  })
