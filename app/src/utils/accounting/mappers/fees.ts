 ...
 * operation. The mapper preserves that source evidence; JournalEntry assembly
...
/** Map fee skims into source postings; JournalEntry assembly reconciles their counterpart. */
