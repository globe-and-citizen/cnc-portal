 ...
 * This allows for easy imports: import { useGetTeamsQuery, useGetNotificationsQuery } from '@/queries'
 */
...
export * from './fixedReturnOffering.queries'
