...
interface AddressMapping {
  ...
  'ExpenseAccountUpgradeModule#ExpenseAccount'?: string
}
...
export const EXPENSE_ACCOUNT_LOGIC_ADDRESS = 
  addresses['ExpenseAccountUpgradeModule#ExpenseAccount'] || 
  addresses['ExpenseAccountModule#ExpenseAccount'] ||
  ''
