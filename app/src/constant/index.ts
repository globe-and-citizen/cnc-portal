...
export const EXPENSE_ACCOUNT_BEACON_ADDRESS = import.meta.env.VITE_APP_EXPENSE_ACCOUNT_BEACON_ADDRESS
export const EXPENSE_ACCOUNT_LOGIC_ADDRESS = import.meta.env.VITE_APP_EXPENSE_ACCOUNT_LOGIC_ADDRESS
export const EXPENSE_ACCOUNT_ADDRESS = import.meta.env.VITE_APP_EXPENSE_ACCOUNT_ADDRESS
