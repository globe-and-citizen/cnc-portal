...
// Bank events
export const bankDeposit = onchainTable("bank_deposit", (t) => ({
...
export const bankTokenDeposit = onchainTable("bank_token_deposit", (t) => ({
...
export const bankTransfer = onchainTable("bank_transfer", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
...
export const bankTokenTransfer = onchainTable("bank_token_transfer", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  sender: t.hex().notNull(),
  to: t.hex().notNull(),
...
export const bankFeePaid = onchainTable("bank_fee_paid", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
...
export const electionVote = onchainTable("election_vote", (t) => ({
...
export const electionResult = onchainTable("election_result", (t) => ({
  id: t.text().primaryKey(), // `${contractAddress}-${electionId}`
  contractAddress: t.hex().notNull(),
  electionId: t.bigint().notNull(),
...
export const proposalTally = onchainTable("proposal_tally", (t) => ({
  id: t.text().primaryKey(), // `${contractAddress}-${proposalId}`
  contractAddress: t.hex().notNull(),
  proposalId: t.bigint().notNull(),
...
export const boardApproval = onchainTable("board_approval", (t) => ({
...
// InvestorV1 events
export const investorMint = onchainTable("investor_mint", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
...
export const investorDividendPaid = onchainTable("investor_dividend_paid", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  shareholder: t.hex().notNull(),
  token: t.hex().notNull(),
...
export const cashRemunerationDeposit = onchainTable("cash_remuneration_deposit", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  depositor: t.hex().notNull(),
  amount: t.bigint().notNull(),
...
export const cashRemunerationWithdraw = onchainTable("cash_remuneration_withdraw", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
...
export const cashRemunerationWageClaim = onchainTable("cash_remuneration_wage_claim", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
...
export const safeDeposit = onchainTable("safe_deposit", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  depositor: t.hex().notNull(),
  token: t.hex().notNull(),
...
export const expenseDeposit = onchainTable("expense_deposit", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  depositor: t.hex().notNull(),
  amount: t.bigint().notNull(),
...
export const expenseTokenDeposit = onchainTable("expense_token_deposit", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  depositor: t.hex().notNull(),
  token: t.hex().notNull(),
...
export const expenseTransfer = onchainTable("expense_transfer", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  withdrawer: t.hex().notNull(),
  to: t.hex().notNull(),
...
export const expenseTokenTransfer = onchainTable("expense_token_transfer", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  withdrawer: t.hex().notNull(),
  to: t.hex().notNull(),
...
export const expenseApproval = onchainTable("expense_approval", (t) => ({
  id: t.text().primaryKey(),
  contractAddress: t.hex().notNull(),
  signatureHash: t.text().notNull(), // bytes32 as hex
