...
**Read `AGENTS.md` first.** It covers repo layout, setup, per-subproject commands, architecture notes, conventions, and the mandatory
code-quality gate before pushing.
