...
This folder catalogues **every way money moves** across the CNC contracts, maps each one to a journal entry, and runs a **full worked
example** end to end so the numbers can be trusted.
