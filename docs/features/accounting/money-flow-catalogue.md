...
**Issue:** [#2126](https://github.com/globe-and-citizen/cnc-portal/issues/2126) — catalogue every CNC contract monetary interaction and reconcile its use cases with the accounting.
**Goal:** [#1887](https://github.com/globe-and-citizen/cnc-portal/issues/1887).
**Status:** Draft.
