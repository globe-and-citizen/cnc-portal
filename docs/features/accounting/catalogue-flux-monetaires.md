...
> **v1.1 (2026-06-14)** — Précisions issues de la revue des contrats : §3.3 récapitulatif consolidé des mints SHER (défaut **D** pour les mints directs), UC-CASH-04 reformulé en _paiement fondé sur des actions_ au taux fixe du `SafeDepositRouter`, nouveau **UC-CASH-06** (claim multi-actifs), §3.4 vesting à deux régimes (cash vs SHER), et clarification de réconciliation « Σ `Minted` en parts, pas en valeur ».
...
### 2.7 Vesting — acquisition différée _(non indexé)_
...
### 2.8 Tips — pourboires _(non indexé)_
...
### 2.9 AdCampaignManager — campagnes publicitaires _(non indexé)_
...
_(Cr Cash au grant = sortie de trésorerie ; ou Owner Capital si apport en nature de l'owner.)_
...
- **UC-VEST-02** (_point de reconnaissance_) : `Dr Comp Expense · Cr Investor Equity` au taux fixe, **non-cash** — c'est UC-CASH-04 déclenché par `release`.
