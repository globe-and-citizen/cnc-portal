...
One continuous scenario to exercise **every** money flow of the CNC, from 1 to N. Do each step in order. Keep amounts
small so the maths stays easy to check. Extends the Sprint Script in
[#2255](https://github.com/globe-and-citizen/cnc-portal/issues/2255) to cover all use cases.

- [ ] **1.** Create a team with the six contracts deployed (Bank, FeeCollector, CashRemuneration, ExpenseAccount,
      InvestorV1, SafeDepositRouter + Safe).
