...
A trimmed-down version of the full [Readme](./Readme.md), scoped to what v0 actually needs to ship. Just wiring an embeddable widget on top
...
_[← Back to Payment Gate flow & edge cases](./flow-and-edge-cases.md)_ · _[Full user stories](./Readme.md)_
