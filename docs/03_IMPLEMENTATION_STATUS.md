...
**Overall Progress:** 35/50 implemented (70%) | 7 in progress (14%) | 7 pending (14%)
...
- Open the relevant feature README from the [Feature User Stories Index](./02_USER_STORIES.md) for acceptance criteria
